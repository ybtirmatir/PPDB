...
<script src="<?php echo base_url('assets/tinymce/js/tinymce/plugins/table/plugin.dev.js');?>" />
<script src="<?php echo base_url('assets/tinymce/js/tinymce/plugins/paste/plugin.dev.js');?>" />
<script src="<?php echo base_url('assets/tinymce/js/tinymce/plugins/spellchecker/plugin.dev.js');?>" />
</script>
		...
		<link src="<?php echo base_url('assets/jquery/jquery-3.3.1.js');?>"rel="stylesheet" />
    <link src="<?php echo base_url('assets/bootstrap/bootstrap.bundle.js');?>"rel="stylesheet" />
    <link src="<?php echo base_url('assets/ckeditor/ckeditor.js');?>"rel="stylesheet" />
